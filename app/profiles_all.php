...
left join c_master_gender g on l.lreg_usr_rel_ho_id = g.ho_id
 ...
 and lum_id not in (select l_target_rel_lum_id from d_likes where l_rel_lum_id = ".$_USER['lum_id']." and l_valid =1)
...
<hr>
                   <div class="row">
                        ...
                        <input type="hidden" name="prof_like" value="<?php echo md5($row['lum_id']) ?>" />
