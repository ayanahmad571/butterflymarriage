...
$boxsql = "SELECT * FROM `e_sv_modules`";
...
style="border:4px solid red" ';
		...
		<div class="panel-body"> 
			...
			<p>Min Admin: '.$boxrw['mo_min_ad_level'].'</p> 
			<p>
			';
			if($boxrw['mo_valid']==1){
				echo '
 ...
 <div class="col-md-4">
	<div class="panel panel-color panel-inverse">
		...
		<div class="panel-body"> 
            ...
            <p>Min Admin Level: <input class="form-control"  required  name="mod_a_minadl" type="number" max="10" min="0" placeholder=" 0 to 10" /></p> 
...
<div class="form-group">
	<label>If not Logged in: </label>
	<input type="text" name="edit_ifnologin" class="form-control" value="'.$mrw['mo_if_no_log_in'].'">
</div>

<div class="form-group">
	<label>Minimum Admin Level: </label>
	<input type="text" name="edit_mominadlvl" class="form-control" value="'.$mrw['mo_min_ad_level'].'">
</div>
