            ...
            <div class="media-main">
                <div class="info">
                    	<div align="center" class="col-sm-12">
                        	<strong >Mutal Connections</strong>
                        </div>  
                    </div>
                </div>
            </div>                                
...
left join c_master_gender g on l.lreg_usr_rel_ho_id = g.ho_id
 ...
 and lum_id in (select l_rel_lum_id from d_likes where l_target_rel_lum_id  = ".$_USER['lum_id']." and l_valid =1)
...
$l = getdatafromsql($conn, "select * from d_likes where l_valid =1 and l_rel_lum_id = ".$_USER['lum_id']." and l_target_rel_lum_id = ".$row['lum_id']."");
if(is_array($l)){
...
<hr>
<?php
$l = getdatafromsql($conn, "select * from d_approve_chat where ch_valid =1
 and ((ch_lum_id_1 = ".$_USER['lum_id']." and ch_lum_id_2 = ".$row['lum_id'].")  )
  ");
if(!is_array($l)){
?>
                  ...
                  <div class="row">
                        ...
                        <input type="hidden" name="prof_cont" value="<?php echo md5(md5($row['lum_id'])) ?>" />
                        <input type="submit" class="btn btn-warning" value="Request Contact Details" />
                        </form>
    ...
    $('#winfwiun<?php echo $row['lum_id'] ?>').on('submit', function(e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                $("#tingting<?php echo $row['lum_id'] ?>").html("Contact Details Requested");
            },
...
<?php
	...
	?>
	                  <div class="row">
                    	<div id="tingting" align="center" class="col-sm-12">
	...
	?>
	                  <div class="row">
                    	<div id="tingting" align="center" class="col-sm-12">
                        Contact Details Available in the Chat section.
                        </div>  
                    </div>
