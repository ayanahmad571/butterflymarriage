            ...
            <div class="media-main">
                <div class="info">
                    	<div align="center" class="col-sm-12">
                        	<strong >People that liked your profile</strong>
                        </div>  
                    </div>
                </div>
            </div>                                
...
?>
                  ...
                  <div class="row">
                        ...
                        <input type="hidden" name="prof_olike" value="<?php echo md5($row['lum_id']) ?>" />
                        <input type="submit" class="btn btn-primary" value="Like the profile" />
                        </form>
    ...
    $('#winfwiun<?php echo $row['lum_id'] ?>').on('submit', function(e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                $("#tingting<?php echo $row['lum_id'] ?>").html("Profile Liked");
            },
